...
public class Tags {
	...
	public static String CLIENT_NAME_OPEN_TAG = "<CLIENT_NAME>";// 3
	public static String CLIENT_NAME_CLOSE_TAG = "</CLIENT_NAME>";// 4
	...
	public static String CLIENT_OPEN_TAG = "<CLIENT>";// 22
	public static String CLIENT_CLOSE_TAG = "</CLIENT>";// 23
	...
	public static String PASSWORD_OPEN_TAG = "<PASSWORD>"; // 34
	public static String PASSWORD_CLOSE_TAG = "</PASSWORD>"; // 35
	// ------------------
